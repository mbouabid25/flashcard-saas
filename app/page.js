...
const MyPage = () => {
  ...
  const fetchFlashcardSets = async () => {
    ...
    const handleNextCard = () => {
      setCurrentCardIndex(
        (prevIndex) => (prevIndex + 1) % flashcardSets.length
      );
    };
    ...
    return (
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, #00F260 0%, #0575E6 50%, #7F00FF 100%)",
          minHeight: "100vh",
          color: "#fff",
          padding: "20px",
        }}
            ...
            <Grid item xs={12} md={4}>
              ...
              >
                <CardContent>
                  ...
                  <Typography>
                    Our platform is designed with simplicity in mind, so you can
                    focus on learning.
                  </Typography>
                </CardContent>
              </Card>
